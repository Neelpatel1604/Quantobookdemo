...
export default function MessageList({ messages, isLoading, onSendExample }: MessageListProps) {
  ...
  return (
    <div className="h-[550px] md:h-[550px] overflow-y-auto mb-4 p-2 md:p-4 bg-gray-50 rounded-lg">
      {messages.length === 0 ? (
        <div className="h-full flex flex-col items-center justify-center text-center gap-4 md:gap-6 px-2">
          ...
          <div className="text-gray-500">
            ...
            <p className="text-sm mb-4 md:mb-6">Ask me about bookkeeping, financial insights, or discrepancies.</p>
          </div>

          {/* Example Questions */}
          <div className="w-full max-w-md">
            <div className="flex items-center gap-2 mb-2 md:mb-3 justify-center">
            ...
            <div className="grid grid-cols-1 gap-2">
              {EXAMPLE_QUESTIONS.map((q, i) => (
                <Button 
                  key={i}
                  variant="outline" 
                  className="justify-start font-normal text-left text-gray-700 h-auto py-2 text-xs md:text-sm"
